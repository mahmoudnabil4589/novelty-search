...
//    }
    ...
    public Individual[] start(
        ...
        report(outputDir);
        // Chaeck if the rare solutions is found
        boolean rareSolutionFound = false;
        // Each loop represents one generation
        do {
            // Update Novelty neighbours
            InvertedNoveltyMetric.neighbours = Arrays.asList(currentPopulation);
